...
{
	return is_sid_match(current_cred(), susfs_zygote_sid, KERNEL_ZYGOTE_DOMAIN);
}

bool susfs_is_current_zygote_next_domain(void)
{
	return is_sid_match(current_cred(), susfs_zygote_next_sid,
			    KERNEL_ZYGOTE_NEXT_DOMAIN);
}

bool susfs_is_current_ksu_domain(void)
{
	return is_sid_match(current_cred(), susfs_ksu_sid, KERNEL_SU_CONTEXT);
}

bool susfs_is_current_init_domain(void)
{
	return is_sid_match(current_cred(), susfs_init_sid, KERNEL_INIT_DOMAIN);
}
